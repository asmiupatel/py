...
are_all_words_equal = word1 == word2 and word1 == word3 # bool: True if all three words are equal
...
ends_with_a = word1[-1] == 'a' or word1[-1] == 'A' # bool: True if word1 ends with letter a or A
